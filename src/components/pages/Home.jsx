...
export default function Home() {
  ...
  const items = [
    { id: 1, title: "Pink Dream Cake", price: "$45.99", img: cakee },
    { id: 2, title: "Artisan Pastries Box", price: "$32.99", img: ArtisanPastries },
    { id: 3, title: "Wedding Elegance", price: "$250.00", img: weddingcake },
    { id: 4, title: "Birthday Celebration", price: "$55.00", img: birthdaycake },
    { id: 5, title: "Cookie Collection", price: "$24.00", img: cookies },
    { id: 6, title: "Homemade Pies", price: "$28.50", img: pies }
  ];
    ...
    <div className="home-wrapper">
      ...
      <section className="banner4">
        <div className="how-section">
          ...
          <p className="how-subtext">Simple steps to get your perfect cake</p>
      ...
      <section className="section-blog">
        <div className="blog-section2">
          <h1 className="tittle-blog">Latest from Our Blog</h1>
          <div className="grid-blog">
            {posts.map((post, i) => (
              <div className="card-blog" key={i}>
                <div className="blog-wrapper-image">
                  <img src={post.img} alt={post.title} className="img-blog" />
                  <span className="tag-blog">{post.tag}</span>
                </div>
                <div className="content-blog">
                  <h2 className="blog-title-card">{post.title}</h2>
                  <button className="readmore-blog">
                    Read More <span>→</span>
                  </button>
                </div>
              </div>
