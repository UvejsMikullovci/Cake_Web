    ...
    <div className="about-wrapper">
      ...
      <section className="visit-section">
        <div className="visit-banner">
          <h1 className="visit-title">Visit Us Today!</h1>
          <p className="visit-title2">
            Come taste the difference that passion and quality make. We can't wait
            to serve you!
          </p>
          <p className="street-p">📍 123 Sweet Street, Bakery Town, BT 12345</p>
